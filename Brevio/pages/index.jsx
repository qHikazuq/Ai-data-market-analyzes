        ...
        {!isMobile && (
          <div style={{ display: "flex", alignItems: "center", gap: "36px" }}>
            ...
            <button
              ...
              style={{ background: C.accent, color: "#0a0c10", border: "none", borderRadius: "4px", padding: "8px 22px", fontSize: "11px", letterSpacing: "0.14em", textTransform: "uppercase", cursor: "pointer", fontFamily: "DM Sans, sans-serif", fontWeight: 600, whiteSpace: "nowrap" }}>
              Start Free
            </button>
          </div>
        )}
          ...
          <div style={{ padding: "6px 0 10px" }}>
            ...
            <div style={{ padding: "10px 12px 4px" }}>
              <button
                ...
                style={{ width: "100%", background: C.accent, color: "#0a0c10", border: "none", borderRadius: "6px", padding: "11px", fontSize: "11px", letterSpacing: "0.14em", textTransform: "uppercase", cursor: "pointer", fontFamily: "DM Sans, sans-serif", fontWeight: 600 }}>
                Start Free
              </button>
            </div>
          </div>
    ...
    <section style={{ minHeight: "calc(100vh - 104px)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "60px 24px 80px", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", textAlign: "center", maxWidth: "800px" }}>
        ...
        <div style={{ display: "flex", gap: "12px", justifyContent: "center", flexWrap: "wrap", marginBottom: "72px" }}>
          <button
            onClick={() => window.location.href = '/dashboard'}
            style={{ background: C.accent, color: "#0a0c10", border: "none", borderRadius: "5px", padding: "14px 32px", fontSize: "13px", letterSpacing: "0.12em", textTransform: "uppercase", cursor: "pointer", fontFamily: "DM Sans, sans-serif", fontWeight: 600 }}>
            Start for Free
          </button>
          <button
            onClick={() => document.getElementById('how-it-works')?.scrollIntoView({ behavior: 'smooth' })}
            style={{ background: "transparent", color: C.text, border: `1px solid ${C.border}`, borderRadius: "5px", padding: "14px 28px", fontSize: "13px", letterSpacing: "0.06em", cursor: "pointer", fontFamily: "DM Sans, sans-serif" }}>
            See how it works →
          </button>
        </div>
...
function HowItWorksSection() {
  ...
  return (
    <section id="how-it-works" style={{ padding: "100px 24px", maxWidth: "1000px", margin: "0 auto" }}>
      <FadeIn>
...
function PricingSection() {
  ...
  return (
    <section id="pricing" style={{ padding: "100px 24px", background: C.bgAlt }}>
      ...
      <FadeIn>
        <div style={{ maxWidth: "620px", margin: "0 auto", textAlign: "center", position: "relative" }}>
          ...
          <div style={{ display: "flex", gap: "12px", justifyContent: "center", flexWrap: "wrap" }}>
            <button
              onClick={() => window.location.href = '/dashboard'}
              style={{ background: C.accent, color: "#0a0c10", border: "none", borderRadius: "5px", padding: "14px 36px", fontSize: "13px", letterSpacing: "0.12em", textTransform: "uppercase", cursor: "pointer", fontFamily: "DM Sans, sans-serif", fontWeight: 600 }}>
              Start for Free
            </button>
            <button
              onClick={() => document.getElementById('pricing')?.scrollIntoView({ behavior: 'smooth' })}
              style={{ background: "transparent", color: C.text, border: `1px solid ${C.border}`, borderRadius: "5px", padding: "14px 28px", fontSize: "13px", cursor: "pointer", fontFamily: "DM Sans, sans-serif" }}>
              View Pricing
            </button>
          </div>
